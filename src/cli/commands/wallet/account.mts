...
export function createWalletAccountAddCommand(): Command {
...
export function createWalletAccountRemoveCommand(): Command {
...
export function createWalletAccountCommand(): Command {
  return new Command('account')
    .description('Manage accounts (address groups) inside a wallet')
    .addCommand(createWalletAccountAddCommand())
    .addCommand(createWalletAccountRemoveCommand())
}

export const walletAccountAddCommand = createWalletAccountAddCommand()
export const walletAccountRemoveCommand = createWalletAccountRemoveCommand()
export const walletAccountCommand = createWalletAccountCommand()
